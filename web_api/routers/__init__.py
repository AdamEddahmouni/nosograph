...
routers = [kg_router, repurpose_router, bio_router, analysis_router, synergy_router, adverse_events_router, expression_router, cart_router, biomarker_router, semantic_router, system_router]
