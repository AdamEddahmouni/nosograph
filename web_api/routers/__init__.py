...
from web_api.routers.cross_disease import router as cross_disease_router
...
routers = [kg_router, repurpose_router, bio_router, analysis_router, synergy_router, adverse_events_router, expression_router, cart_router, biomarker_router, semantic_router, evidence_router, extractor_router, monitor_router, cross_disease_router, system_router]
