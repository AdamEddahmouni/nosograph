...
CLI_SMOKE_COMMANDS = [
    ...
    ("synergy", ["synergy", "--disease", "sle", "--top", "5"], "SYNERGY"),
    ("network", ["network", "--disease", "sle"], "NETWORK PHARMACOLOGY"),
    ("expression", ["expression", "--disease", "sle", "--top", "5"], "EXPRESSION"),
    ("cart", ["cart", "--disease", "sle", "--top", "5"], "CAR-T"),
    ("biomarker", ["biomarker", "--disease", "sle", "--top", "5"], "BIOMARKER"),
    (
        "literature",
