...
def test_failed_resolution(resolver: DiseaseIdResolver) -> None:
  result = resolver.resolve_entry({"id": "unknown_xyz", "name": "Completely Unknown Syndrome XYZ"})
...
def test_build_report(resolver: DiseaseIdResolver) -> None:
  results = [
    ResolutionResult("a", "A", efo_id="EFO_0001370", resolution_confidence=1.0, needs_review=False),
