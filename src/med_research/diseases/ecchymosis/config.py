"""phenotype (ECCHYMOSIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (ECCHYMOSIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "ecchymosis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_ecchymosis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
