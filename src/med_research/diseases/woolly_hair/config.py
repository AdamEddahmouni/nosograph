"""phenotype (WOOLLY_HAIR) disease configuration.
...
PIPELINE_LABEL = "phenotype (WOOLLY_HAIR)"
...
SCREENING_PROFILE = {
    "strategy_id": "woolly_hair-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_woolly_hair_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
