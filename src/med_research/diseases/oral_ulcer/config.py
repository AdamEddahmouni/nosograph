"""phenotype (ORAL_ULCER) disease configuration.
...
PIPELINE_LABEL = "phenotype (ORAL_ULCER)"
...
SCREENING_PROFILE = {
    "strategy_id": "oral_ulcer-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_oral_ulcer_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
