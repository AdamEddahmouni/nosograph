"""epidermolysis bullosa (EPIDERMOLYSIS_BULLOSA_SIMPLEX_WITH_MOTTLED_PIGMENTATION) disease configuration.
...
PIPELINE_LABEL = 'epidermolysis bullosa (EPIDERMOLYSIS_BULLOSA_SIMPLEX_WITH_MOTTLED_PIGMENTATION)'
...
SCREENING_PROFILE = {
    "strategy_id": "epidermolysis_bullosa_simplex_with_mottled_pigmentation-screening-v1",
    "pathway_keywords": [
        "adhesion",
        "cascade",
        "cell",
    ...
    "source": "scaffold_epidermolysis_bullosa_simplex_with_mottled_pigmentation_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
