"""phenotype (DROWSINESS) disease configuration.
...
PIPELINE_LABEL = "phenotype (DROWSINESS)"
...
SCREENING_PROFILE = {
    "strategy_id": "drowsiness-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_drowsiness_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
