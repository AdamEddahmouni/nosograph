"""phenotype (NEPHROPATHY) disease configuration.
...
PIPELINE_LABEL = "phenotype (NEPHROPATHY)"
...
SCREENING_PROFILE = {
    "strategy_id": "nephropathy-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_nephropathy_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
