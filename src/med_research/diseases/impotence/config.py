"""phenotype (IMPOTENCE) disease configuration.
...
PIPELINE_LABEL = "phenotype (IMPOTENCE)"
...
SCREENING_PROFILE = {
    "strategy_id": "impotence-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_impotence_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
