"""phenotype (RENAL_CYST) disease configuration.
...
PIPELINE_LABEL = "phenotype (RENAL_CYST)"
...
SCREENING_PROFILE = {
    "strategy_id": "renal_cyst-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_renal_cyst_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
