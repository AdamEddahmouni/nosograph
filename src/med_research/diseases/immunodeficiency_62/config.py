"""immunodeficiency 62 (IMMUNODEFICIENCY_62) disease configuration.
...
PIPELINE_LABEL = "immunodeficiency 62 (IMMUNODEFICIENCY_62)"
...
# ── Literature Mining ────────────────────────────────────────────────────
PUBMED_QUERIES = [
    "(immunodeficiency 62[Title/Abstract]) AND (treatment[Title/Abstract])",
    "(immunodeficiency 62[Title/Abstract]) AND (genetics[Title/Abstract] OR genomics[Title/Abstract])",
    "(immunodeficiency 62[Title/Abstract]) AND (clinical trial[Title/Abstract])",
    "(immunodeficiency 62[Title/Abstract]) AND (biomarker[Title/Abstract])",
]

# ── Clinical trials / GWAS search terms (consumed by the web + bio modules) ─
TRIAL_QUERY = "immunodeficiency 62 OR immunodeficiency"
GWAS_SEARCH_TERMS = ["immunodeficiency 62", "immunodeficiency"]
...
SCREENING_PROFILE = {
    "strategy_id": "immunodeficiency_62-screening-v1",
    "pathway_keywords": [
        "(th2)",
        "apoptosis",
        "cascade",
    ...
    "source": "scaffold_immunodeficiency_62_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
