"""phenotype (ARTHROPATHY) disease configuration.
...
PIPELINE_LABEL = "phenotype (ARTHROPATHY)"
...
SCREENING_PROFILE = {
    "strategy_id": "arthropathy-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_arthropathy_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
