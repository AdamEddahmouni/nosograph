"""phenotype (PHOTOPHOBIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (PHOTOPHOBIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "photophobia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_photophobia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
