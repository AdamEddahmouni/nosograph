"""phenotype (PARALYSIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (PARALYSIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "paralysis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_paralysis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
