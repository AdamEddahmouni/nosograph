"""phenotype (BLINDNESS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (BLINDNESS)'
...
SCREENING_PROFILE = {
    "strategy_id": "blindness-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_blindness_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
