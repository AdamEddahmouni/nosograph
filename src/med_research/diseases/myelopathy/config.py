"""phenotype (MYELOPATHY) disease configuration.
...
PIPELINE_LABEL = "phenotype (MYELOPATHY)"
...
SCREENING_PROFILE = {
    "strategy_id": "myelopathy-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_myelopathy_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
