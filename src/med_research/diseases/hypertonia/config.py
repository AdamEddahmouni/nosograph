"""phenotype (HYPERTONIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (HYPERTONIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "hypertonia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hypertonia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
