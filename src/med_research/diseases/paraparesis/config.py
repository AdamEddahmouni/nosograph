"""phenotype (PARAPARESIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (PARAPARESIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "paraparesis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_paraparesis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
