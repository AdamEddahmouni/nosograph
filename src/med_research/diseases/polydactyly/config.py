"""phenotype (POLYDACTYLY) disease configuration.
...
PIPELINE_LABEL = "phenotype (POLYDACTYLY)"
...
SCREENING_PROFILE = {
    "strategy_id": "polydactyly-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_polydactyly_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
