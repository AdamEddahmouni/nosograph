"""phenotype (GAIT_ATAXIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (GAIT_ATAXIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "gait_ataxia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_gait_ataxia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
