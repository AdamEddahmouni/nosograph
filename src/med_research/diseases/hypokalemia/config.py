"""phenotype (HYPOKALEMIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HYPOKALEMIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "hypokalemia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hypokalemia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
