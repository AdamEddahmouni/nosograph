"""phenotype (ARTHRALGIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (ARTHRALGIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "arthralgia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_arthralgia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
