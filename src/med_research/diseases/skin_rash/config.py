"""phenotype (SKIN_RASH) disease configuration.
...
PIPELINE_LABEL = 'phenotype (SKIN_RASH)'
...
SCREENING_PROFILE = {
    "strategy_id": "skin_rash-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_skin_rash_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
