"""phenotype (CATAPLEXY) disease configuration.
...
PIPELINE_LABEL = "phenotype (CATAPLEXY)"
...
SCREENING_PROFILE = {
    "strategy_id": "cataplexy-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_cataplexy_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
