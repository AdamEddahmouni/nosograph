"""phenotype (ASTIGMATISM) disease configuration.
...
PIPELINE_LABEL = "phenotype (ASTIGMATISM)"
...
SCREENING_PROFILE = {
    "strategy_id": "astigmatism-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_astigmatism_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
