"""phenotype (OCULAR_PAIN) disease configuration.
...
PIPELINE_LABEL = "phenotype (OCULAR_PAIN)"
...
SCREENING_PROFILE = {
    "strategy_id": "ocular_pain-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_ocular_pain_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
