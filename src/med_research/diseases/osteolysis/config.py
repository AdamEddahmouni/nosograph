"""phenotype (OSTEOLYSIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (OSTEOLYSIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "osteolysis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_osteolysis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
