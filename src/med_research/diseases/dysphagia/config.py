"""phenotype (DYSPHAGIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (DYSPHAGIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "dysphagia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_dysphagia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
