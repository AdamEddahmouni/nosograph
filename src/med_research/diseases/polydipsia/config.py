"""phenotype (POLYDIPSIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (POLYDIPSIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "polydipsia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_polydipsia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
