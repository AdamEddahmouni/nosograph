"""phenotype (LEUKOPENIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (LEUKOPENIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "leukopenia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_leukopenia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
