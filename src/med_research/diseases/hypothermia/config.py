"""phenotype (HYPOTHERMIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HYPOTHERMIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "hypothermia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hypothermia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
