"""phenotype (MOTOR_DELAY) disease configuration.
...
PIPELINE_LABEL = 'phenotype (MOTOR_DELAY)'
...
SCREENING_PROFILE = {
    "strategy_id": "motor_delay-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_motor_delay_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
