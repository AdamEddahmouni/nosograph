"""phenotype (GLYCOSURIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (GLYCOSURIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "glycosuria-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_glycosuria_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
