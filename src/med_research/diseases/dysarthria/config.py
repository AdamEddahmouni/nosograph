"""phenotype (DYSARTHRIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (DYSARTHRIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "dysarthria-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_dysarthria_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
