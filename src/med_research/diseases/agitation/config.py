"""phenotype (AGITATION) disease configuration.
...
PIPELINE_LABEL = "phenotype (AGITATION)"
...
SCREENING_PROFILE = {
    "strategy_id": "agitation-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_agitation_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
