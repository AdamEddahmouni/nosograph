"""piebaldism (PIEBALDISM) disease configuration.
...
PIPELINE_LABEL = "piebaldism (PIEBALDISM)"
...
# ── Literature Mining ────────────────────────────────────────────────────
PUBMED_QUERIES = [
    "(piebaldism[Title/Abstract]) AND (treatment[Title/Abstract])",
    "(piebaldism[Title/Abstract]) AND (genetics[Title/Abstract] OR genomics[Title/Abstract])",
    "(piebaldism[Title/Abstract]) AND (clinical trial[Title/Abstract])",
    "(piebaldism[Title/Abstract]) AND (biomarker[Title/Abstract])",
]

# ── Clinical trials / GWAS search terms (consumed by the web + bio modules) ─
TRIAL_QUERY = "piebaldism OR piebaldism"
GWAS_SEARCH_TERMS = ["piebaldism", "piebaldism"]
...
SCREENING_PROFILE = {
    "strategy_id": "piebaldism-screening-v1",
    "pathway_keywords": [
        "cell",
        "hedgehog",
        "interferon",
    ...
    "source": "scaffold_piebaldism_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
