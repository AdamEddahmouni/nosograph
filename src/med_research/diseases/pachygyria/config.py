"""phenotype (PACHYGYRIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (PACHYGYRIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "pachygyria-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_pachygyria_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
