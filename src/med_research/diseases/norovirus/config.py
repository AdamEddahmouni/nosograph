"""Norovirus gastroenteritis (NOROVIRUS) disease configuration.
...
PIPELINE_LABEL = "Norovirus gastroenteritis (NOROVIRUS)"
DEFAULT_SAMPLE_SIZE = 50

# ── Symptoms (used by adverse_events/profiler.py) ────────────────────────
# TODO: add the clinical symptoms of Norovirus gastroenteritis
SYMPTOMS = []
...
TRIAL_QUERY = "Norovirus gastroenteritis OR Norovirus"
GWAS_SEARCH_TERMS = ["Norovirus gastroenteritis", "Norovirus"]
...
SCREENING_PROFILE = {
    "strategy_id": "norovirus-screening-v1",
    "pathway_keywords": [
        "cascade",
        "chemokine",
        "coagulation",
    ...
    "source": "scaffold_norovirus_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
