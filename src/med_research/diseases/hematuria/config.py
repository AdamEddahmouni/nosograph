"""phenotype (HEMATURIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HEMATURIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "hematuria-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hematuria_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
