"""chronic back pain (CHRONIC_LOW_BACK_PAIN) disease configuration.
...
PIPELINE_LABEL = "chronic back pain (CHRONIC_LOW_BACK_PAIN)"
DEFAULT_SAMPLE_SIZE = 50

# ── Symptoms (used by adverse_events/profiler.py) ────────────────────────
# TODO: add the clinical symptoms of chronic back pain
SYMPTOMS = []
...
TRIAL_QUERY = "chronic back pain OR chronic"
GWAS_SEARCH_TERMS = ["chronic back pain", "chronic"]
...
SCREENING_PROFILE = {
    "strategy_id": "chronic_low_back_pain-screening-v1",
    "pathway_keywords": [
        "cardiac",
        "cell",
        "channel",
    ...
    "source": "scaffold_chronic_low_back_pain_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
