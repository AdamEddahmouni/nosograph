"""phenotype (GRANULOMA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (GRANULOMA)'
...
SCREENING_PROFILE = {
    "strategy_id": "granuloma-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_granuloma_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
