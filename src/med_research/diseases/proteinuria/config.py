"""phenotype (PROTEINURIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (PROTEINURIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "proteinuria-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_proteinuria_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
