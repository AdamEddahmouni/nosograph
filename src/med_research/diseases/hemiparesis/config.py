"""phenotype (HEMIPARESIS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HEMIPARESIS)'
...
SCREENING_PROFILE = {
    "strategy_id": "hemiparesis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hemiparesis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
