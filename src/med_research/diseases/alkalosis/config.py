"""phenotype (ALKALOSIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (ALKALOSIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "alkalosis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_alkalosis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
