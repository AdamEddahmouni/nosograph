"""phenotype (BRADYCARDIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (BRADYCARDIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "bradycardia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_bradycardia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
