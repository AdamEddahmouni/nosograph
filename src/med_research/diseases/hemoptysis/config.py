"""phenotype (HEMOPTYSIS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HEMOPTYSIS)'
...
SCREENING_PROFILE = {
    "strategy_id": "hemoptysis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hemoptysis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
