"""phenotype (HETEROTAXY) disease configuration.
...
PIPELINE_LABEL = "phenotype (HETEROTAXY)"
...
SCREENING_PROFILE = {
    "strategy_id": "heterotaxy-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_heterotaxy_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
