"""phenotype (HYDROURETER) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HYDROURETER)'
...
SCREENING_PROFILE = {
    "strategy_id": "hydroureter-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hydroureter_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
