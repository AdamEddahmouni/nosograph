"""phenotype (BONE_PAIN) disease configuration.
...
PIPELINE_LABEL = "phenotype (BONE_PAIN)"
...
SCREENING_PROFILE = {
    "strategy_id": "bone_pain-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_bone_pain_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
