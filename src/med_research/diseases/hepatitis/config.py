"""phenotype (HEPATITIS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HEPATITIS)'
...
SCREENING_PROFILE = {
    "strategy_id": "hepatitis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hepatitis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
