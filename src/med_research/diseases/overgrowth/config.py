"""phenotype (OVERGROWTH) disease configuration.
...
PIPELINE_LABEL = 'phenotype (OVERGROWTH)'
...
SCREENING_PROFILE = {
    "strategy_id": "overgrowth-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_overgrowth_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
