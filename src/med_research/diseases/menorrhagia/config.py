"""phenotype (MENORRHAGIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (MENORRHAGIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "menorrhagia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_menorrhagia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
