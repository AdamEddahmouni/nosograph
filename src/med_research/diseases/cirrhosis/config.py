"""phenotype (CIRRHOSIS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (CIRRHOSIS)'
...
SCREENING_PROFILE = {
    "strategy_id": "cirrhosis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_cirrhosis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
