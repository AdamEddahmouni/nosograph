"""phenotype (ARRHYTHMIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (ARRHYTHMIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "arrhythmia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_arrhythmia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
