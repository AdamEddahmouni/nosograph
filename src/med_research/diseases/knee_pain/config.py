"""phenotype (KNEE_PAIN) disease configuration.
...
PIPELINE_LABEL = "phenotype (KNEE_PAIN)"
...
SCREENING_PROFILE = {
    "strategy_id": "knee_pain-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_knee_pain_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
