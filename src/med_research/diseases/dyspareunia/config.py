"""phenotype (DYSPAREUNIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (DYSPAREUNIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "dyspareunia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_dyspareunia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
