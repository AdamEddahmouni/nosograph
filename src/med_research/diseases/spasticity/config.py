"""phenotype (SPASTICITY) disease configuration.
...
PIPELINE_LABEL = "phenotype (SPASTICITY)"
...
SCREENING_PROFILE = {
    "strategy_id": "spasticity-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_spasticity_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
