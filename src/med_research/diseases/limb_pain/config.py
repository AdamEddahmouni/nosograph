"""phenotype (LIMB_PAIN) disease configuration.
...
PIPELINE_LABEL = 'phenotype (LIMB_PAIN)'
...
SCREENING_PROFILE = {
    "strategy_id": "limb_pain-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_limb_pain_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
