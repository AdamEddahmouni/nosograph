"""phenotype (PARASOMNIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (PARASOMNIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "parasomnia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_parasomnia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
