"""phenotype (TRICHIASIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (TRICHIASIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "trichiasis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_trichiasis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
