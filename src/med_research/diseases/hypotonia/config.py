"""phenotype (HYPOTONIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HYPOTONIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "hypotonia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hypotonia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
