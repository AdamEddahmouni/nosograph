"""phenotype (SKIN_ULCER) disease configuration.
...
PIPELINE_LABEL = 'phenotype (SKIN_ULCER)'
...
SCREENING_PROFILE = {
    "strategy_id": "skin_ulcer-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_skin_ulcer_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
