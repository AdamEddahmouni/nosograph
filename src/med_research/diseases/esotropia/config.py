"""phenotype (ESOTROPIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (ESOTROPIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "esotropia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_esotropia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
