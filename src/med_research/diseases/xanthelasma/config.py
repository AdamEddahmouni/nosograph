"""phenotype (XANTHELASMA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (XANTHELASMA)'
...
SCREENING_PROFILE = {
    "strategy_id": "xanthelasma-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_xanthelasma_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
