"""phenotype (FASCIITIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (FASCIITIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "fasciitis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_fasciitis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
