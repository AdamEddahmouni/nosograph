"""phenotype (PES_CAVUS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (PES_CAVUS)'
...
SCREENING_PROFILE = {
    "strategy_id": "pes_cavus-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_pes_cavus_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
