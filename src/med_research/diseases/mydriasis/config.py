"""phenotype (MYDRIASIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (MYDRIASIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "mydriasis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_mydriasis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
