"""phenotype (NYSTAGMUS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (NYSTAGMUS)'
...
SCREENING_PROFILE = {
    "strategy_id": "nystagmus-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_nystagmus_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
