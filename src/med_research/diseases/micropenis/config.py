"""phenotype (MICROPENIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (MICROPENIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "micropenis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_micropenis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
