"""phenotype (ADENOIDITIS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (ADENOIDITIS)'
...
SCREENING_PROFILE = {
    "strategy_id": "adenoiditis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_adenoiditis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
