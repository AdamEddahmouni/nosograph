"""phenotype (TACHYCARDIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (TACHYCARDIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "tachycardia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_tachycardia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
