"""phenotype (MASTOIDITIS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (MASTOIDITIS)'
...
SCREENING_PROFILE = {
    "strategy_id": "mastoiditis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_mastoiditis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
