"""phenotype (STRABISMUS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (STRABISMUS)'
...
SCREENING_PROFILE = {
    "strategy_id": "strabismus-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_strabismus_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
