"""phenotype (OSTEOPENIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (OSTEOPENIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "osteopenia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_osteopenia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
