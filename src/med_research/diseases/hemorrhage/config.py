"""phenotype (HEMORRHAGE) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HEMORRHAGE)'
...
SCREENING_PROFILE = {
    "strategy_id": "hemorrhage-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hemorrhage_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
