"""phenotype (HYPODONTIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HYPODONTIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "hypodontia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hypodontia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
