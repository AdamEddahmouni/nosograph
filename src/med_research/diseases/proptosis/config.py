"""phenotype (PROPTOSIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (PROPTOSIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "proptosis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_proptosis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
