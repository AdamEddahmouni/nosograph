"""phenotype (HOT_FLASHES) disease configuration.
...
PIPELINE_LABEL = "phenotype (HOT_FLASHES)"
...
SCREENING_PROFILE = {
    "strategy_id": "hot_flashes-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hot_flashes_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
