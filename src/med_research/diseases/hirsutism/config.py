"""phenotype (HIRSUTISM) disease configuration.
...
PIPELINE_LABEL = 'phenotype (HIRSUTISM)'
...
SCREENING_PROFILE = {
    "strategy_id": "hirsutism-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_hirsutism_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
