"""genetic disorder (TYROSINEMIA_TYPE_2) disease configuration.
...
PIPELINE_LABEL = 'genetic disorder (TYROSINEMIA_TYPE_2)'
...
SCREENING_PROFILE = {
    "strategy_id": "tyrosinemia_type_2-screening-v1",
    "pathway_keywords": [
        "cardiac",
        "cascade",
        "cell",
    ...
    "source": "scaffold_tyrosinemia_type_2_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
