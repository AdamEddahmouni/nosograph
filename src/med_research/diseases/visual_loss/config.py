"""phenotype (VISUAL_LOSS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (VISUAL_LOSS)'
...
SCREENING_PROFILE = {
    "strategy_id": "visual_loss-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_visual_loss_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
