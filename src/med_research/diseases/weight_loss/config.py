"""phenotype (WEIGHT_LOSS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (WEIGHT_LOSS)'
...
SCREENING_PROFILE = {
    "strategy_id": "weight_loss-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_weight_loss_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
