"""phenotype (POLYPHAGIA) disease configuration.
...
PIPELINE_LABEL = "phenotype (POLYPHAGIA)"
...
SCREENING_PROFILE = {
    "strategy_id": "polyphagia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_polyphagia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
