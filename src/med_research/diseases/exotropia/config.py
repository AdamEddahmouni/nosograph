"""phenotype (EXOTROPIA) disease configuration.
...
PIPELINE_LABEL = 'phenotype (EXOTROPIA)'
...
SCREENING_PROFILE = {
    "strategy_id": "exotropia-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_exotropia_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
