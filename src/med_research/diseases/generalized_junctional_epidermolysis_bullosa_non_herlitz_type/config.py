"""epidermolysis bullosa (GENERALIZED_JUNCTIONAL_EPIDERMOLYSIS_BULLOSA_NON_HERLITZ_TYPE) disease configuration.
...
PIPELINE_LABEL = 'epidermolysis bullosa (GENERALIZED_JUNCTIONAL_EPIDERMOLYSIS_BULLOSA_NON_HERLITZ_TYPE)'
...
SCREENING_PROFILE = {
    "strategy_id": "generalized_junctional_epidermolysis_bullosa_non_herlitz_type-screening-v1",
    "pathway_keywords": [
        "adhesion",
        "cascade",
        "cell",
    ...
    "source": "scaffold_generalized_junctional_epidermolysis_bullosa_non_herlitz_type_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
