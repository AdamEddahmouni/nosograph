"""phenotype (PLEURITIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (PLEURITIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "pleuritis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_pleuritis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
