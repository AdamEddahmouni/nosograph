"""phenotype (TORTICOLLIS) disease configuration.
...
PIPELINE_LABEL = 'phenotype (TORTICOLLIS)'
...
SCREENING_PROFILE = {
    "strategy_id": "torticollis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_torticollis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
