"""phenotype (CHOLANGITIS) disease configuration.
...
PIPELINE_LABEL = "phenotype (CHOLANGITIS)"
...
SCREENING_PROFILE = {
    "strategy_id": "cholangitis-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_cholangitis_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
