"""phenotype (SYNDACTYLY) disease configuration.
...
PIPELINE_LABEL = 'phenotype (SYNDACTYLY)'
...
SCREENING_PROFILE = {
    "strategy_id": "syndactyly-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_syndactyly_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
