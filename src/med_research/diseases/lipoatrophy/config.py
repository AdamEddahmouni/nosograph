"""phenotype (LIPOATROPHY) disease configuration.
...
PIPELINE_LABEL = 'phenotype (LIPOATROPHY)'
...
SCREENING_PROFILE = {
    "strategy_id": "lipoatrophy-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_lipoatrophy_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
