"""phenotype (MYOCLONUS) disease configuration.
...
PIPELINE_LABEL = "phenotype (MYOCLONUS)"
...
SCREENING_PROFILE = {
    "strategy_id": "myoclonus-screening-v1",
    "pathway_keywords": [
        "remodeling",
    ],
    "mechanism_keywords": [
    ...
    "source": "scaffold_myoclonus_knowledge_graph",
    "curated_inputs": [
        "pathways",
        "drugs",
        "screening_strategy",
