...
async def kg_communities(disease: ResolvedDisease) -> dict[str, Any]:
...
async def kg_multi_network(
    diseases: str = Query(
        "sle,ra,ms,ibd,t1d,ad",
        description="Comma-separated disease IDs (defaults to CI-validated subset)",
    ),
