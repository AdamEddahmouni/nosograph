...
from med_research.web.models.semantic import SemanticSearchResponse as SemanticSearchModel
...
@router.get("/api/semantic/search", response_model=SemanticSearchModel)
