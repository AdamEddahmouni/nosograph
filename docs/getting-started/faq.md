...
**How many diseases does it support?** 10,407 registry modules in v0.2.0; 88 pass strict L2 validation. Counts: [public-status.yaml](../generated/public-status.yaml).
