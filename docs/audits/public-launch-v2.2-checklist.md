...
- [docs/audits/release-readiness-report.md](release-readiness-report.md) gates reviewed.
...
1. Create GitHub Release from `v2.2.0` per [RELEASING.md](https://github.com/AdamEddahmouni/nosograph/blob/master/RELEASING.md)
...
- **Governance:** [GOVERNANCE.md](https://github.com/AdamEddahmouni/nosograph/blob/master/GOVERNANCE.md)
