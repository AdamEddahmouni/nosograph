...
Canonical metadata: repository `CITATION.cff` (version **0.2.0**, URL `https://github.com/AdamEddahmouni/nosograph`). README BibTeX must match.

- Preferred v0.2.0 citation: [10.5281/zenodo.22062925](https://doi.org/10.5281/zenodo.22062925) (version DOI).
- All-versions concept DOI: [10.5281/zenodo.22055279](https://doi.org/10.5281/zenodo.22055279).
