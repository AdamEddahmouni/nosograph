...
| [Open Targets Platform](https://platform.opentargets.org/) | Disease–gene and disease–drug associations for KG curation | [Open Targets data license](https://platform-docs.opentargets.org/licence) |
