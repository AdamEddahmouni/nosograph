...
| [Reactome](https://reactome.org/) | Pathway annotations and biomedical store imports | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) |
| [Gene Ontology (GO)](https://geneontology.org/) | Biological process and pathway ontology imports | [CC BY 4.0](https://geneontology.org/docs/go-citation-policy/) |
| [Uberon](https://uberon.github.io/) | Anatomical ontology imports | [CC BY 3.0 / CC BY 4.0](https://uberon.github.io/) |
...
| [DailyMed / openFDA](https://dailymed.nlm.nih.gov/) | Drug label evidence and openFDA imports | Public domain / U.S. government works where applicable |
| [ClinVar](https://www.ncbi.nlm.nih.gov/clinvar/) | Clinical variant-condition claims and imports | [NCBI ClinVar data usage](https://www.ncbi.nlm.nih.gov/clinvar/docs/maintenance_use/) — U.S. government works where applicable |
| [ChEMBL](https://www.ebi.ac.uk/chembl/) | Drug-target bioactivity (live connector & adapter) | [EMBL-EBI ChEMBL terms](https://www.ebi.ac.uk/chembl/) |
| [PubChem](https://pubchem.ncbi.nlm.nih.gov/) | Compound–gene bioactivity (live connector & adapter) | [NCBI PubChem policies](https://pubchem.ncbi.nlm.nih.gov/docs/programmatic-access) |
