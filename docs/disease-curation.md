...
The registry contains **10,407 disease modules**: **88** L2 pipeline-ready modules (strict-validated at v2.3.0), a small L3 expression-curated set, and more than 10,000 Open Targets auto-generated scaffolds. This playbook applies to the curated set; scaffolds must be curated (below) before they are treated as research-ready.
