...
- Short: Disease intelligence connected across biomedical knowledge, evidence, and provenance (open source, research use only).
- Approved headline, social bio, 50 / 150 words, and calls to action: [launch-copy.md](../project/launch-copy.md)
- Logo usage: [assets/brand](../assets/brand/README.md) — canonical construction, variants, clear space, typography, and misuse rules
