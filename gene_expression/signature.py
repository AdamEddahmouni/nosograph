...
def get_signature(disease: str = "sle", tissue: Optional[str] = None,
    ...
    if source in ("auto", "geo"):
        try:
            from gene_expression.geo import get_expression_signature
...
def _get_curated_signature(disease: str = "sle") -> dict:
    ...
    from gene_expression.correlator import SLE_DOWNREGULATED, SLE_UPREGULATED
...
def list_available_signatures() -> list:
    ...
    from gene_expression.geo import CACHE_DIR as GEO_CACHE_DIR
    sigs = []
